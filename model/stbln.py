...
class ST_BLN_block(nn.Module):
    def __init__(self, in_channels, out_channels, graph_dim1=25, graph_dim2=25, symmetric=False, cuda_=False,
        ...
        self.bln = BilinearMapping(in_channels, out_channels, graph_dim1, graph_dim2, symmetric, cuda_)
...
class STBLN(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, symmetric=False, graph=None,
                 graph_args=dict(), in_channels=3, cuda_=True):
        ...
        self.layers = nn.ModuleDict(
            {'layer1': ST_BLN_block(in_channels, 64, num_point, num_point, symmetric, cuda_, residual=False),
             'layer2': ST_BLN_block(64, 64, num_point, num_point, symmetric, cuda_),
             'layer3': ST_BLN_block(64, 64, num_point, num_point, symmetric, cuda_),
             'layer4': ST_BLN_block(64, 64, num_point, num_point, symmetric, cuda_),
             'layer5': ST_BLN_block(64, 128, num_point, num_point, symmetric, cuda_, stride=2),
             'layer6': ST_BLN_block(128, 128, num_point, num_point, symmetric, cuda_),
             'layer7': ST_BLN_block(128, 128, num_point, num_point, symmetric, cuda_),
             'layer8': ST_BLN_block(128, 256, num_point, num_point, symmetric, cuda_, stride=2),
             'layer9': ST_BLN_block(256, 256, num_point, num_point, symmetric, cuda_),
             'layer10': ST_BLN_block(256, 256, num_point, num_point, symmetric, cuda_)}
        )
